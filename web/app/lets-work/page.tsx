    ...
    <main className="min-h-screen flex flex-col md:flex-row">
      ...
      <section id="midPanel" className="flex-1 flex flex-col">
        <div>
          ...
          <div id="marketingContent" className="md:grid grid-cols-3 p-8 border-b md:border-b-2 border-black dark:border-off-white">
            <div className="col-span-2 lg:px-44">
              ...
              <Link href={'/form'}  >
                <Button className="bg-primary1B p-2.5 pl-4 pr-16 hover:bg-primary text-white dark:text-off-white font-label text-label-large font-bold">Fill in Form
                </Button>
              </Link>
          ...
          <div id="emptyDiv" className="h-14 md:h-16 border-b md:border-b-2 border-black dark:border-off-white">
          </div>
          <div id="servicesContent1" className="grid grid-cols-1 md:grid-cols-3">
            <div id="brandIdentity" className="p-8 border-b md:border-r-2 md:border-b-2 border-black dark:border-off-white">
              ...
              <span className='flex flex-col lg:flex-row space-y-4 lg:space-y-0 justify-between'>
                <div className='flex'>
                  <Link href={'/form/brand-identity'} target='_blank' className='pl-2 flex text-primary border-b-2 border-b-primary sm:border-b-primary1B font-headlines text-headline-small uppercase  hover:text-white hover:bg-primary1B hover:shadow-sm hover:duration-150'>
            ...
            <div id="uixDesign" className="p-8 border-b md:border-r-2 md:border-b-2 border-black dark:border-off-white">
              <img src={"https://images.unsplash.com/photo-1626798801949-8ec7c7a43918?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt="brand identity banner" className="object-cover h-64 w-full" />
            ...
            <div id="printDesign" className="p-8 border-b md:border-r-2 md:border-b-2 border-black dark:border-off-white">
              <img src={"https://images.unsplash.com/photo-1626798801949-8ec7c7a43918?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt="brand identity banner" className="object-cover h-64 w-full" />
          ...
          <div id="servicesContent2" className="grid grid-cols-1 md:grid-cols-2">
            <div id="socialMedia" className="p-8 border-b md:border-r-2 md:border-b-2 border-black dark:border-off-white">
              <img src={"https://images.unsplash.com/photo-1626798801949-8ec7c7a43918?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt="brand identity banner" className="object-cover h-64 w-full" />
            ...
            <div id="saas" className="p-8 border-b md:border-r-2 md:border-b-2 border-black dark:border-off-white">
              <img src={"https://images.unsplash.com/photo-1626798801949-8ec7c7a43918?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt="brand identity banner" className="object-cover h-64 w-full" />
          ...
          <div id="ctaContent" className="p-8 py-16 md:grid grid-cols-3">
            <div className="col-span-2 lg:px-44">
              ...
              <Link href={'/chat'} >
                <Button className="bg-secondary p-2.5 pl-4 pr-16 hover:bg-secondary-regal text-white dark:text-off-white font-label text-label-large font-bold">Let&apos;s Chat
                </Button>
              </Link>
            </div>
          </div>
