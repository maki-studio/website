...
export function ProjectCard({ link = 'default value', imgSrc, title }: ProjectCardProps) {
  return <div className={''}>
    ...
    <div>
      <div className='flex'>
        <Link href={link} className='flex text-primary border-b-2 border-b-primary sm:border-b-primary1B font-headlines text-headline-small uppercase  hover:text-white hover:bg-primary1B hover:shadow hover:duration-150'>
